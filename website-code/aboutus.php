...
<body>
    <div class="overall-container">
        ...
        <section class="margin-left-right">
            ...
            <img src="images/exterior-wide.jpg"
                alt="Exterior view of Cantor College, focused on showing the scale of the main building." width="800"
                height="250" class="resize-image">
        </section>
